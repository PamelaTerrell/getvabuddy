...
export default function HomePage() {
  return (
    ...
    <h1>Get VA Buddy</h1>
    <p className="tagline">Helping you navigate VA forms and benefits with ease</p>
  </section>
...
<li>
  ...
  >
    <FaPrint className="print-icon" /> VA Form 21P-534EZ – Application for DIC, Death Pension, and/or Accrued Benefits
        ...
        <p>
          These forms can be printed and mailed to the VA. If you need help
          printing or filling them out, we’re here to assist.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Be sure to include your name, Social Security number or VA file
          number, and any supporting documents.
        </p>
      </section>
